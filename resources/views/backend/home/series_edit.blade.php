...
if(request('id')){
	...
	if(!$rd){
		...
		echo '<script>location.href="/backend/home/series"</script>';
		exit;
	}
}else{
	$rd = \App\Cm::new_obj();
    ...
    <div class="col-xs-12">
		<div class="card">
			<div class="card-header">
				<a href="/backend/home/series">首頁系列作品</a> - 編輯
			</div>
			<div class="card-body">
					...
					<div class="form-footer">
						<div class="form-group">
							<div class="col-md-9 col-md-offset-3">
								...
								<a class="btn btn-default" href="/backend/home/series">回上一頁</a>
								<input type="hidden" name="_token" value="{{csrf_token()}}">
								<input type="hidden" name="id" value="{{request('id')}}">
								<input type="hidden" name="lang" value="{{$rd->lang ? $rd->lang : session('lang')}}">
								<input type="hidden" name="position" value="index_series">
							</div>
						</div>
					</div>
				</form>
