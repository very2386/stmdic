    ...
    <div class="col-xs-12">
		<div class="card">
			<div class="card-header">
				<a href="/backend/marketing/prospect">目前展會</a> - 編輯
			</div>
			<div class="card-body">
						...
						<div class="section-body">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<div class="input-group">
								        <input type="text" name="date" class="form-control datepicker"  value="{{$rd->date}}">
								    </div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									@if(request('id'))
										<?php
										$files = \App\OtherFiles::where('position','prospect')->where('cm_id',request('id'))->get();
										?>
										@foreach($files as $rs)
					...
					<div class="form-footer">
						<div class="form-group">
							...
							<div class="col-md-9 col-md-offset-3">
								...
								<input type="hidden" name="position" value="prospect">
							</div>
						</div>
					</div>
				</form>
