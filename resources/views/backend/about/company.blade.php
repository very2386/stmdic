<?php
$rd = \App\Cm::where('position', 'about')->where('type', 'company')->where('lang', session('lang'))->first();
if(!$rd) $rd = \App\Cm::create(['position'=>'about', 'type'=>'company', 'lang'=>session('lang')]);
?>
    ...
    <div class="col-xs-12">
		<div class="card">
			<div class="card-header">
				<a href="/backend/about/company">關於我們 - 公司簡介</a>
			</div>
			<div class="card-body">
					...
					<div class="form-footer">
						<div class="form-group">
							<div class="col-md-12">
								...
								<input type="hidden" name="name" value="公司簡介">
							</div>
						</div>
					</div>
				</form>
