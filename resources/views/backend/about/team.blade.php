<?php
$rd = \App\Cm::where('position', 'about')->where('type', 'team')->where('lang', session('lang'))->first();
if(!$rd) $rd = \App\Cm::create(['position'=>'about', 'type'=>'team', 'lang'=>session('lang')]);
?>
    ...
    <div class="col-xs-12">
		<div class="card">
			<div class="card-header">
				<a href="/backend/about/team">關於我們 - 經營團隊</a>
			</div>
			<div class="card-body">
					...
					<div class="form-footer">
						<div class="form-group">
							<div class="col-md-12">
								...
								<input type="hidden" name="name" value="經營團隊">
							</div>
						</div>
					</div>
				</form>
