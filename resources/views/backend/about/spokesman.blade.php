<?php
$rd = \App\Cm::where('position', 'about')->where('type', 'spokesman')->where('lang', session('lang'))->first();
if(!$rd) $rd = \App\Cm::create(['position'=>'about', 'type'=>'spokesman', 'lang'=>session('lang')]);
?>
    ...
    <div class="col-xs-12">
		<div class="card">
			<div class="card-header">
				<a href="/backend/about/spokesman">關於我們 - 發言人</a>
			</div>
			<div class="card-body">
					...
					<div class="form-footer">
						<div class="form-group">
							<div class="col-md-12">
								...
								<input type="hidden" name="type" value="spokesman">
								<input type="hidden" name="name" value="發言人">
							</div>
						</div>
					</div>
				</form>
