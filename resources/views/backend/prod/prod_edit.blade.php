...
$series_rs = \App\Cm::where('position', 'series')->where('type', 'products')->where('mstatus', 'Y')->get();
$works_rs = \App\Cm::where('position', 'works')->where('type', 'products')->where('mstatus', 'Y')->get();
?>
    ...
    <div class="col-xs-12">
		<div class="card">
			<div class="card-header">
				<a href="/backend/prod/index">商品管理</a> - 編輯
			</div>
			<div class="card-body">
						...
						<div class="section-body">
							...
							<div class="form-group pad-btm-20">
								...
								<div class="col-md-9">
							  		<select name="series" id="series" class="form-control">
					  			  		<option value="" {{!$spec->series ? 'selected':''}}>無</option>
							...
							<div class="form-group pad-btm-20">
								...
								<div class="col-md-9">
							  		<select name="works" id="works" class="form-control">
					  			  		<option value="" {{!$spec->works ? 'selected':''}}>無</option>
							...
							<div class="form-group">
								<div class="col-md-3">
									...
									<div><button type="button" class="btn btn-success" onclick="load_media('{{request('id')}}', 'products')">媒體庫</button></div>
								</div>
								<div class="col-md-9">
