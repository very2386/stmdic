<?php
$rd = \App\Cm::where('position', 'title')->where('type', 'prod')->where('lang', session('lang'))->first();
$id = $rd ? $rd->id : '';
?>
		...
		<div class="card card-banner no-br">
			<div class="card-header">
			  <div class="card-title">
			    <div class="title">產品規畫標題圖片</div>
			  </div>
			</div>
			<div class="card-body">
				<form class="form form-horizontal" id="title_upload" name="title_upload" enctype="multipart/form-data" method="post" action="/do/edit/title">
					<div class="w80">
